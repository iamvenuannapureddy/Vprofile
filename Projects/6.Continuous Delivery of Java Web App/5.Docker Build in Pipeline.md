Here's a professional breakdown for your notes:

### Lecture: Writing Code to Build Docker Image and Upload to Amazon ACR
...
1. **Pipeline Variables**:
   - `registry_credential`: AWS credential name for ACR.
   - `app_registry`: ACR registry name and image.
   - `wprofile_registry`: URL of ACR repository.
...
- **Verification**:
  - Navigate to Amazon ACR to view uploaded images.

---

This detailed breakdown covers both the Dockerfile and Jenkins pipeline needed for building, tagging, and deploying Docker images to Amazon ACR.
